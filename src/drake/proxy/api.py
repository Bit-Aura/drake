...
from drake.core.database import DB_FILE
...
async def generate_workflow_from_nl(payload: NLGeneratePayload) -> Dict[str, Any]:
    from drake.ai_clustering.nl_compiler import compile_nl_to_workflow
    from drake.core.database import insert_generated_workflow
    import asyncio
...
async def run_pipeline_task():
    try:
        ...
        from drake.core.database import init_db_sync, set_pipeline_status
...
async def prometheus_metrics():
    ...
    try:
        ...
        # Fetch cache metrics
        from drake.core.compatibility.sources import get_cache_metrics
